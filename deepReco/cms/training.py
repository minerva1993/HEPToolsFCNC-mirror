...
loader = TMVA.DataLoader("deepReco01")
...
loader.PrepareTrainingAndTestTree(
    sigCut, bkgCut,
    "nTrain_Signal=200000:nTrain_Background=200000:nTest_Signal=60000:nTest_Background=60000:SplitMode=Random:NormMode=NumEvents:!V"
)

factory.BookMethod(loader, TMVA.Types.kBDT, "BDT", "!H:!V:NTrees=800:MinNodeSize=5%:MaxDepth=4:BoostType=Grad:Shrinkage=0.4:SeparationType=GiniIndex:nCuts=40")
#factory.BookMethod(loader, TMVA.Types.kBDT, "BDT", "!H:!V:NTrees=200:MinNodeSize=5%:MaxDepth=3:BoostType=AdaBoost:SeparationType=GiniIndex:nCuts=20")
