...
loader = TMVA.DataLoader("deepReco03")
...
loader.PrepareTrainingAndTestTree(
    sigCut, bkgCut,
    "nTrain_Signal=50000:nTrain_Background=50000:nTest_Signal=20000:nTest_Background=20000:SplitMode=Random:NormMode=NumEvents:!V"
)
