...
void anamva1(){
  ...
  TFile* outputFile = TFile::Open("output1.root", "RECREATE"); 
  ...
  TMVA::DataLoader *loader=new TMVA::DataLoader("run1");
  ...
  //DNN part  
    ...
    TString trainingString1 = "TrainingStrategy="
                              ...
                              "BatchSize=500,"
                              "DropConfig=0.0+0.2+0.2+0.0,"  // Dropout
                              "WeightDecay=0.001,"
                              "Regularization=L2,"
                              "TestRepetitions=5,"
                              "Multithreading=True";
    ...
    TString layoutString = "Layout=TANH|30,TANH|20,TANH|10,LINEAR";
