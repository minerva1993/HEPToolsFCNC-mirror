...
void anamva_nojetmult(){

  TMVA::Tools::Instance();

  TFile* outputFile = TFile::Open("output_nojet.root", "RECREATE"); 
  ...
  TMVA::DataLoader *loader=new TMVA::DataLoader("nojetmultiplicity");
  ...
  TCut mycuts="(H_Mass < 300 && BJet_Pt < 300 && CJet_Pt < 300 && Jet1_Pt < 300 && Jet2_Pt < 300 && Jet3_Pt < 300 && Jet1_CSV > 0 && Jet2_CSV > 0 && Jet3_CSV > 0 && Jet4_CSV > 0)";
  TCut mycutb="(H_Mass < 300 && BJet_Pt < 300 && CJet_Pt < 300 && Jet1_Pt < 300 && Jet2_Pt < 300 && Jet3_Pt < 300 && Jet1_CSV > 0 && Jet2_CSV > 0 && Jet3_CSV > 0 && Jet4_CSV > 0)";
