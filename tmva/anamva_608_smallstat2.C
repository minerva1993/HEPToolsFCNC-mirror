...
void anamva_608_smallstat2(){

  TMVA::Tools::Instance();

  TFile* outputFile = TFile::Open("output_608_smallstat2.root", "RECREATE"); 
  ...
  TMVA::DataLoader *loader=new TMVA::DataLoader("train_2_smallstat2");
