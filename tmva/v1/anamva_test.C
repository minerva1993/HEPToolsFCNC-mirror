...
void anamva_test(){
  ...
  TCut mycuts="(NJets > 0 && NBJets_M > 0 && NCJets_M >0 && BJMDPhi < 10 && BJMDEta < 10 && CJMDPhi < 10 && CJMDEta < 10 && BJMDR < 3.2)";
  TCut mycutb="(NJets > 0 && NBJets_M > 0 && NCJets_M >0 && BJMDPhi < 10 && BJMDEta < 10 && CJMDPhi < 10 && CJMDEta < 10 && BJMDR < 3.2)";
  ...
  loader->AddVariable("BJMDR",'F');
  loader->AddVariable("CJMDPhi",'F');
  loader->AddVariable("CJMDEta",'F');
