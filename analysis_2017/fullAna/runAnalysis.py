...
"""
runAna(inputdir+version,"SingleElectron_Run2017B.root","DataSingleEG")
runAna(inputdir+version,"SingleMuon_Run2017B.root", "DataSingleMu")
runAna(inputdir+version,"W1JetsToLNu_50-150.root","w1jets50to150")
runAna(inputdir+version,"W1JetsToLNu_150-250.root","w1jets150to250")
...
runAna(inputdir+version,"W2JetsToLNu_250-400.root","w2jets250to400")
"""
#runAna(inputdir+version,"W2JetsToLNu_400-inf.root","w2jets400toinf")
