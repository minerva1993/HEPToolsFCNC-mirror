...
#loader = TMVA.DataLoader("STHct_j4b2_01")
#loader = TMVA.DataLoader("STHct_j4b4_01")
loader = TMVA.DataLoader("STHut_j3b3_01")
#loader = TMVA.DataLoader("STHut_j4b2_01")
#loader = TMVA.DataLoader("STHut_j4b4_01")
...
sigCut = TCut("nevt %3!=0 && njets==3 && nbjets_m==3")
bkgCut = TCut("nevt %3!=0 && njets==3 && nbjets_m==3")

loader.PrepareTrainingAndTestTree(
    sigCut, bkgCut,
    #"nTrain_Signal=45000:nTrain_Background=50000:SplitMode=Random:NormMode=NumEvents:!V" #j3b3 hct
    #"nTrain_Signal=43000:nTrain_Background=100000:nTest_Background=100000:SplitMode=Random:NormMode=NumEvents:!V" #j4b2 hct
    #"nTrain_Signal=26000:nTrain_Background=90000:SplitMode=Random:NormMode=NumEvents:!V" #j4b3 hct
    "nTrain_Signal=31000:nTrain_Background=50000:SplitMode=Random:NormMode=NumEvents:!V" #j3b3 hut
    #"nTrain_Signal=43000:nTrain_Background=100000:nTest_Background=100000:SplitMode=Random:NormMode=NumEvents:!V" #j4b2 hut
    #"nTrain_Signal=26000:nTrain_Background=90000:SplitMode=Random:NormMode=NumEvents:!V" #j4b3 hut
)
