...
sigCut = TCut("nevt %3!=0 && njets==4 && nbjets_m==2")
bkgCut = TCut("nevt %3!=0 && njets==4 && nbjets_m==2")
...
loader.PrepareTrainingAndTestTree(
    ...
    "nTrain_Signal=36000:nTrain_Background=100000:nTest_Background=100000:SplitMode=Random:NormMode=NumEvents:!V" #j4b2 hut
