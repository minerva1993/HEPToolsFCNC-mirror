#ifndef makeTopTuple_h
#define makeTopTuple_h
...
class makeTopTuple : public TSelector {
public :
   ...
   makeTopTuple(TTree * /*tree*/ =0) { }
   virtual ~makeTopTuple() { }
...
#ifdef makeTopTuple_cxx
void makeTopTuple::Init(TTree *tree)
{
