...
void run( TString name )
{
  ...
  TFile *f = TFile::Open("/home/minerva1993/fcnc/analysis_2017/reco/classifier/2016/scoreST03/"+name, "READ");
  if (f->IsOpen()==kFALSE){
    f->Close();
    gSystem->Exit(0);
  }
  ...
  assign.Add("/home/minerva1993/fcnc/analysis_2017/reco/classifier/2016/scoreST03/"+name);
