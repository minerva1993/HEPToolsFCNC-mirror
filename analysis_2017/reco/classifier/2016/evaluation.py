...
data = TFile.Open('/home/minerva1993/fcnc/analysis_2017/reco/classifier/2016/mkNtuple/j3b2_st/'+filename)
...
target = TFile.Open('/home/minerva1993/fcnc/analysis_2017/reco/classifier/2016/scoreST'+ver+'/score_'+filename,'RECREATE')
...
reader.BookMVA('BDT', TString('/home/minerva1993/fcnc/analysis_2017/reco/classifier/2016/training/deepRecoSTFCNC'+ver+'/weights/TMVAClassification_BDT.weights.xml'))
