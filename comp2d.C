...
void comp2d(TString var = "bjmDPhiDEta" ){
  ...
  TH2F * h_NJet_Ch0_S1_Top_Hct = (TH2F *) f_Top_Hct->Get(Form("h_%s_Ch0_S1_Top_Hct",var.Data()));
  TH2F * h_NJet_Ch0_S1_Top_Hut = (TH2F *) f_Top_Hut->Get(Form("h_%s_Ch0_S1_Top_Hut",var.Data()));
  TH2F * h_NJet_Ch0_S1_AntiTop_Hct = (TH2F *) f_AntiTop_Hct->Get(Form("h_%s_Ch0_S1_AntiTop_Hct",var.Data()));
  TH2F * h_NJet_Ch0_S1_AntiTop_Hut = (TH2F *) f_AntiTop_Hut->Get(Form("h_%s_Ch0_S1_AntiTop_Hut",var.Data()));
  TH2F * h_NJet_Ch0_S1_ttbb = (TH2F *) f_ttbb->Get(Form("h_%s_Ch0_S1_ttbb",var.Data()));
  ...
  h_NJet_Ch0_S1_ttbb->Draw("colz");
  h_NJet_Ch0_S1_ttbb->SetStats(0000);
  c->SetRightMargin(0.15);
  c->Print(Form("c_%s.pdf(",var.Data()));

  h_NJet_Ch0_S1_Top_Hct->Draw("colz");
  h_NJet_Ch0_S1_Top_Hct->SetStats(0000);
  c->Print(Form("c_%s.pdf",var.Data()));

  h_NJet_Ch0_S1_Top_Hut->Draw("colz");
  h_NJet_Ch0_S1_Top_Hut->SetStats(0000);
  c->Print(Form("c_%s.pdf",var.Data()));

  h_NJet_Ch0_S1_AntiTop_Hct->Draw("colz");
  h_NJet_Ch0_S1_AntiTop_Hct->SetStats(0000);
  c->Print(Form("c_%s.pdf",var.Data()));

  h_NJet_Ch0_S1_AntiTop_Hut->Draw("colz");
  h_NJet_Ch0_S1_AntiTop_Hut->SetStats(0000);
  c->Print(Form("c_%s.pdf)",var.Data()));
