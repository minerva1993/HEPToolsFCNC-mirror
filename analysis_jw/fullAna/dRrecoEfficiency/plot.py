...
hct_recoHm.DrawNormalized('SAME HIST')
l1.Clear()
l1.AddEntry(hct_matchHm, 'matched', 'l')
l1.AddEntry(hct_recoHm, 'Reco', 'l')
l1.Draw('SAME')
...
hut_recoHm.DrawNormalized('SAME HIST')
l1.Clear()
l1.AddEntry(hut_matchHm, 'matched', 'l')
l1.AddEntry(hut_recoHm, 'Reco', 'l')
l1.Draw('SAME')
...
hct_matchdR.SetTitle('#Delta R of gen matched reco b jets (Hut)')
...
l1.Clear()
l1.AddEntry(hct_matchdR, 'matched', 'l')
l1.AddEntry(hct_recodR, 'Reco', 'l')
l1.Draw('SAME')
...
l1.Clear()
l1.AddEntry(hut_matchdR, 'matched', 'l')
l1.AddEntry(hut_recodR, 'Reco', 'l')
l1.Draw('SAME')
