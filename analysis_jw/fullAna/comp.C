...
*/
  compare("m3FCNHkinLepWMass", ch, step);
  compare("m3FCNHkinHadWMass", ch, step);
  compare("m3FCNHkinHMass", ch, step);
  compare("m3FCNHkinDR", ch, step);
  compare("m3FCNHkinTopMWb", ch, step);
  compare("m3FCNHkinTopMHc", ch, step);
