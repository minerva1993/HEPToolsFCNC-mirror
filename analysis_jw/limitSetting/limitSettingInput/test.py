...
mva_out = TFile.Open('/home/minerva1993/fcnc/analysis_jw/tmva/v5/bdt_test_Hct6/output_bdt.root')
...
bdt_bkg = mva_out.Get('/bdt_test_Hct6/Method_BDT/BDT/MVA_BDT_B')
bdt_bkg.Scale(55873/bdt_bkg.Integral())
bdt_bkg.SetName('bdt_bkg')
target.cd()
bdt_bkg.Write()

bdt_sig = mva_out.Get('/bdt_test_Hct6/Method_BDT/BDT/MVA_BDT_S')
