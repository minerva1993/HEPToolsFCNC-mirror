...
for scores in os.listdir('/home/minerva1993/fcnc/analysis_jw/tmva/v3/score_mva/'+ch+'/'):
  ...
  if scores == 'output_'+ch+'_tmva_ttbb.root':
    ...
    bdt_ttbb = TH1F('bdt_ttbb', '', 50, -0.3, 0.3)
    ttbb_tree.Draw('BDTScore>>bdt_ttbb')
    bdt_ttbb.Scale(0.0888153017294)

    keras_ttbb = TH1F('keras_ttbb', '', 50, 0, 1)
    ...
    bdt_ttcc = TH1F('bdt_ttcc', '', 50, -0.3, 0.3)
    ttcc_tree.Draw('BDTScore>>bdt_ttcc')
    bdt_ttcc.Scale(0.0888153017294)

    keras_ttcc = TH1F('keras_ttcc', '', 50, 0, 1)
    ...
    bdt_ttbj = TH1F('bdt_ttbj', '', 50, -0.3, 0.3)
    ttbj_tree.Draw('BDTScore>>bdt_ttbj')
    bdt_ttbj.Scale(0.0888153017294)

    keras_ttbj = TH1F('keras_ttbj', '', 50, 0, 1)
  ...
  #no W+Jets and QCD
    ...
    bdt_others = TH1F('bdt_others', '', 50, -0.3, 0.3)
    zjets_tree.Draw('BDTScore>>bdt_others')
    bdt_others.Scale(2.65549294802)
    bdt_zjets10to50 = TH1F('bdt_zjets10to50', '', 50, -0.3, 0.3)
    ...
    keras_others = TH1F('keras_others', '', 50, 0, 1)
    zjets_tree.Draw('KerasScore>>keras_others')
    keras_others.Scale(2.65549294802)
    keras_zjets10to50 = TH1F('keras_zjets10to50', '', 50, 0, 1)
    ...
    bdt_data_obs = TH1F('bdt_data_obs', '', 50, -0.3, 0.3)
    rd_tree.Draw('BDTScore>>bdt_data_obs')

    keras_data_obs = TH1F('keras_data_obs', '', 50, 0, 1)
    ...
    bdt_tbaruh = TH1F('bdt_tbaruh', '', 50, -0.3, 0.3)
    ...
    keras_tbaruh = TH1F('keras_tbaruh', '', 50, 0, 1)
