void bdt_hut(){
  ...
  TH1D *h_sig = (TH1D*)ftrain->Get("keras_Hut1v2/Method_BDT/BDT/MVA_BDT_S");
  TH1D *h_bkg = (TH1D*)ftrain->Get("keras_Hut1v2/Method_BDT/BDT/MVA_BDT_B");
  ...
  TFile* file = new TFile("shape_BDT_Hut.root","RECREATE");
  h_sig->Write();
  h_bkg->Write();
  h_data->Write();
  file->Close();
