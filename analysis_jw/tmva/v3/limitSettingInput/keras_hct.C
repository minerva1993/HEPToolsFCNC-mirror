void keras_hct(){
  ...
  TH1D *h_sig = (TH1D*)ftrain->Get("keras_Hct2v2/Method_PyKeras/PyKeras/MVA_PyKeras_S");
  TH1D *h_bkg = (TH1D*)ftrain->Get("keras_Hct2v2/Method_PyKeras/PyKeras/MVA_PyKeras_B");
  ...
  TFile* file = new TFile("shape_PyKeras_Hct.root","RECREATE");
  h_sig->Write();
  h_bkg->Write();
  h_data->Write();
  file->Close();
