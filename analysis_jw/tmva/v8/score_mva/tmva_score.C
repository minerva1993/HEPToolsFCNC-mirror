...
void tmva_score::SlaveBegin(TTree * /*tree*/)
{
  ...
  h_scoreKeras = new TH1D(Form("h_scoreKeras_%s",option.Data()), "Keras score", 20, 0, 0.7);
  ...
  h_scoreKerasGen = new TH1D(Form("h_scoreKerasGen_%s",option.Data()), "Keras score", 20, 0, 0.7);
