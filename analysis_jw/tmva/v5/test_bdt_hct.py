...
fout = TFile("output_bdt.root","recreate")
...
loader = TMVA.DataLoader("bdt_test_Hct11")
...
## Load input files
#signalA = TFile("mkNtuple_v5/tmva_AntiTop_Hut.root")
signalB = TFile("mkNtuple_v5/tmva_AntiTop_Hct.root")
#signalC = TFile("mkNtuple_v5/tmva_Top_Hut.root")
signalD = TFile("mkNtuple_v5/tmva_Top_Hct.root")
#sigTreeA = signalA.Get("tmva_tree")
sigTreeB = signalB.Get("tmva_tree")
#sigTreeC = signalC.Get("tmva_tree")
sigTreeD = signalD.Get("tmva_tree")

background1 = TFile("mkNtuple_v5/tmva_tbarchannel.root")
background2 = TFile("mkNtuple_v5/tmva_tbarWchannel.root")
background3 = TFile("mkNtuple_v5/tmva_tchannel.root")
background4 = TFile("mkNtuple_v5/tmva_tWchannel.root")
...
background5 = TFile("mkNtuple_v5/tmva_ttbb.root")
background6 = TFile("mkNtuple_v5/tmva_ttbj.root")
background7 = TFile("mkNtuple_v5/tmva_ttcc.root")
background8 = TFile("mkNtuple_v5/tmva_ttLF.root")
background9 = TFile("mkNtuple_v5/tmva_tt.root")
...
factory.BookMethod(loader, TMVA.Types.kBDT, "BDT", "!H:!V:NTrees=800:MinNodeSize=5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:SeparationType=GiniIndex:nCuts=20")
