...
loader = TMVA.DataLoader("keras5_Hut15")
...
factory.BookMethod(loader, TMVA.Types.kPyKeras, 'Keras+TF',"H:!V:VarTransform=D,G:FilenameModel=model_Hut.h5:NumEpochs=50:BatchSize=1000")#120 epochs
