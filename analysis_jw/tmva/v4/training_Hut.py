...
loader = TMVA.DataLoader("keras4_Hut3")
...
## Load input files
signalA = TFile("mkNtuple_v4/tmva_AntiTop_Hut.root")
#signalB = TFile("mkNtuple_v4/tmva_AntiTop_Hct.root")
signalC = TFile("mkNtuple_v4/tmva_Top_Hut.root")
#signalD = TFile("mkNtuple_v4/tmva_Top_Hct.root")
sigTreeA = signalA.Get("tmva_tree")
#sigTreeB = signalB.Get("tmva_tree")
sigTreeC = signalC.Get("tmva_tree")
#sigTreeD = signalD.Get("tmva_tree")

background1 = TFile("mkNtuple_v4/tmva_tbarchannel.root")
background2 = TFile("mkNtuple_v4/tmva_tbarWchannel.root")
background3 = TFile("mkNtuple_v4/tmva_tchannel.root")
background4 = TFile("mkNtuple_v4/tmva_tWchannel.root")
...
background5 = TFile("mkNtuple_v4/tmva_ttbb.root")
background6 = TFile("mkNtuple_v4/tmva_ttbj.root")
background7 = TFile("mkNtuple_v4/tmva_ttcc.root")
background8 = TFile("mkNtuple_v4/tmva_ttLF.root")
background9 = TFile("mkNtuple_v4/tmva_tt.root")
...
#background10 = TFile("mkNtuple_v4/tmva_wjets.root")
...
loader.PrepareTrainingAndTestTree(
    sigCut, bkgCut,
    "nTrain_Signal=35000:nTrain_Background=440000:SplitMode=Random:NormMode=NumEvents:!V"
)
...
x = Dense(a, kernel_regularizer=l2(0.01))(inputs)#4E-6
...
factory.BookMethod(loader, TMVA.Types.kPyKeras, 'PyKeras',"H:!V:VarTransform=D,G:FilenameModel=model_Hut.h5:NumEpochs=200:BatchSize=200")
...
TMVA.TMVAGui("output_keras_Hut.root")
