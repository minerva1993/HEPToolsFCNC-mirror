...
loader = TMVA.DataLoader("keras4_Hut4")
...
factory.BookMethod(loader, TMVA.Types.kPyKeras, 'PyKeras',"H:!V:VarTransform=D,G:FilenameModel=model_Hut.h5:NumEpochs=100:BatchSize=200")
